...
// 导入服务
import {getUserInfoByOmdUserIdService, getUserReportStatusService} from "@/api/user.js";
...
// 响应式变量
const routeUserId = route.params.omdUserId; // 从路由参数中获取用户ID
    ...
    <el-container>
      ...
      <div class="user-info-container">
        ...
        <div class="user-info-button">
          ...
          <el-button type="info" v-if="omdFriendStatus !== 3  && !omdUserReportStatus" @click="blackFriend">拉黑用户</el-button>
        ...
        <el-descriptions border :label-width="150">
          ...
          <el-descriptions-item align="center" label="昵称" prop="omdUserNickname">{{ omdUserData?.omdUserNickname || '暂无' }}</el-descriptions-item>
          <el-descriptions-item align="center" label="性别" prop="omdUserGender">{{ gender(omdUserData?.omdUserGender) }}</el-descriptions-item>
          <el-descriptions-item align="center" label="地区" prop="omdUserRegion">{{ omdUserData?.omdUserRegion || '暂无' }}</el-descriptions-item>
          <el-descriptions-item align="center" label="生日" prop="omdUserBirthday">{{ omdUserData?.omdUserBirthday || '暂无' }}</el-descriptions-item>
          <el-descriptions-item align="center" label="创建时间" prop="omdUserCreateTime">{{ omdUserData?.omdUserCreateTime }}</el-descriptions-item>
        </el-descriptions>
      </div>
